...
class Locaties
{
    ...
    public static function list(array $filters = []): array
    {
        return self::validateResponse(
            OpenProductConnection::getConnection()->get(self::API_ENDPOINT . 'locaties', $filters)
        )->json();
    }
    ...
    {
        return self::validateResponse(
            OpenProductConnection::getConnection()->get(self::API_ENDPOINT . 'locaties/' . $uuid)
        )->json();
    }
    ...
    public static function create(array $data): array
    {
        ...
        return self::validateResponse(
            OpenProductConnection::getConnection()->post(self::API_ENDPOINT . 'locaties', $data)
        )->json();
    }
    ...
    public static function update(string $uuid, array $data): array
    {
        ...
        return self::validateResponse(
            OpenProductConnection::getConnection()->put(self::API_ENDPOINT . 'locaties/' . $uuid, $data)
        )->json();
    }
    ...
    public static function patch(string $uuid, array $data): array
    {
        ...
        return self::validateResponse(
            OpenProductConnection::getConnection()->patch(self::API_ENDPOINT . 'locaties/' . $uuid, $data)
        )->json();
    }
    ...
    public static function delete(string $uuid): void
    {
        self::validateResponse(
            OpenProductConnection::getConnection()->delete(self::API_ENDPOINT . 'locaties/' . $uuid)
        );
    }
